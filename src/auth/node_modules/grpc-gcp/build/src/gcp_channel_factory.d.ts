...
export declare type GrpcModule = typeof grpcType;
...
export interface GcpChannelFactoryConstructor {
    new (address: string, credentials: grpcType.ChannelCredentials, options: any): GcpChannelFactoryInterface;
}
export declare function getGcpChannelFactoryClass(grpc: GrpcModule): GcpChannelFactoryConstructor;
